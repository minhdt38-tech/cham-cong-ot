...
**Quy ước nhập liệu quan trọng:** tọa độ mỗi đỉnh thửa vẫn nhập theo đúng định dạng cũ `X,Y; X,Y; ...`, nhưng khi dự án đã khai Kinh tuyến trục, X/Y được hiểu là **X (Bắc/Northing), Y (Đông/Easting)** theo đúng quy ước trắc địa Việt Nam — thứ tự bị đảo ngược so với quy ước Cartesian thông thường (x=ngang trước). Đã ghi rõ quy ước này trong phần giải thích của tab Bản đồ GPMB. Hàm quy đổi tự hoán vị đúng trước khi gọi proj4 (proj4 cần thứ tự [Đông, Bắc] tức [easting, northing]).
